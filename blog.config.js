...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，歡迎來到好聽書齋！🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '月半B組', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '好聽書齋', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://sound2024b.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 聲音', // 网站关键词 英文逗号隔开
  ...
  POST_RECOMMEND_COUNT: 15, // 推荐文章数量
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'zh-tw', // 你的 Giscus 語言 e.g 'en', 'zh-TW', 'zh-CN', 預設 'en'
  ...
  // 作废配置
  AVATAR: process.env.NEXT_PUBLIC_AVATAR || '/avatar2.svg', // 作者头像，被notion中的ICON覆盖。若无ICON则取public目录下的avatar.png
