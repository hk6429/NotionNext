...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，歡迎來到好聽書齋，這裡是月半B組聲音庫🎉',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, sound', // 网站关键词 英文逗号隔开
  ...
  // 代码主题 @see https://github.com/PrismJS/prism-s
